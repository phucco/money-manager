<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Transaction Reports</h1>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="panel panel-red">
            <div class="panel-heading">
                <i class="fa fa-bar-chart-o fa-fw"></i> History of Transactions
            </div>
            <div class="panel-body">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php foreach ($list as $row) : $type = $row->type; ?>
						<tr<?php echo ($type == 2) ? ' class="active"' : ''; ?>>
				            <td><?php echo $row->date; ?> 
                                <?php if ($type == 2) : ?>
                                <a href="<?php echo base_url('transaction/income'); ?>">
                                    <span class="btn btn-primary btn-xs glyphicon glyphicon-plus-sign"></span>
                                </a>
                                <?php else : ?>
                                <a href="<?php echo base_url('transaction/expense'); ?>">
                                    <span class="btn btn-danger btn-xs glyphicon glyphicon-minus-sign"></span>
                                </a>
                                <?php endif; ?>
                            </td>
